/**
 * Content collection configuration for jet-w.astro-blog
 *
 * This file provides the default content collection schemas.
 * Users can import and extend these in their own content.config.ts
 */
